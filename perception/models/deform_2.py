# -*- coding: utf-8 -*-
"""
Created on Sat Mar  7 14:46:47 2020
...
#        out_h, out_w = [int(i) for i in offset.get_shape()[1: 3]]  # output feature map size
        ...
        batch_size = int(K.int_shape(inputs)[0])
        channel_in = int(K.int_shape(inputs)[-1])
        in_h, in_w = [int(i) for i in K.int_shape(inputs)[1: 3]]  # input feature map size
        out_h, out_w = [int(i) for i in K.int_shape(offset)[1: 3]]  # output feature map size
