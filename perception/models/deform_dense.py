# -*- coding: utf-8 -*-
"""
Created on Sat Mar  7 11:01:13 2020
...
from perception.models.deform_conv import ConvOffset2D
#from perception.models.deform_2 import DeformableConvLayer
...
class SegmentionModel(ModelBase):
    ...
    def build_model(self):
        ...
        #l_offset = ConvOffset2D(32, name='conv11_offset')(inputs)
        ...
        l_offset = ConvOffset2D(32, name='conv11_offset')(conv1)
        #l_offset = DeformableConvLayer(32, [5, 5], activation='relu', num_deformable_group=1)(conv1)
        conv1 = self.DenseBlock(l_offset, 32)  # 48
        pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)


        #l_offset2 = ConvOffset2D(64, name='conv21_offset')(pool1)
