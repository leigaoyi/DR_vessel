...
from utils.sequeez_excite import squeeze_excite_block, spatial_squeeze_excite_block

from perception.bases.model_base import ModelBase

class Att_Dense(ModelBase):
    def __init__(self,config=None):
        super(Att_Dense, self).__init__(config)
    ...
    def build_model(self):
        ...
        conv4 = self.DenseBlock(conv4, 64)
